   ...
   <div class="modal fade bd-example-modal-lg" id="add-period-modal-primary" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default "  id="sumbitnewperiod">Save changes</button>
            </div>
        </div>
    </div>
</div>
