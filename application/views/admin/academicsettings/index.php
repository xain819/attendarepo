 ...
 <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>public/gleek/assets/images/favicon.png">
    <!-- Custom Stylesheet -->
    <link href="<?= base_url() ?>public/gleek/css/style.css" rel="stylesheet">
    ...
    <script src="<?= base_url() ?>public/gleek/assets/plugins/common/common.min.js"></script>
    <script src="<?= base_url() ?>public/gleek/js/custom.min.js"></script>
    <script src="<?= base_url() ?>public/gleek/js/settings.js"></script>
    <script src="<?= base_url() ?>public/gleek/js/gleek.js"></script>
    <script src="<?= base_url() ?>public/gleek/js/styleSwitcher.js"></script>
    
    <script src="<?= base_url() ?>public/gleek/assets/plugins/raphael/raphael.min.js"></script>
    <script src="<?= base_url() ?>public/gleek/assets/plugins/morris/morris.min.js"></script>
    <script src="<?= base_url() ?>public/gleek/js/dashboard/dashboard-18.js"></script>
